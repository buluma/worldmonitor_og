    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">PALANTIR</span><span class="logo-mobile">World Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <a class="mobile-menu-item" href="https://x.com/aknownunknown1" target="_blank" rel="noopener">
      ...
      <footer class="site-footer">
        ...
        <nav>
          ...
          <a href="/pro">Pro</a>
          <a href="/blog/">Blog</a>
          <a href="https://github.com/buluma/worldmonitor" target="_blank" rel="noopener">GitHub</a>
